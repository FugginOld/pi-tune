...
harness, since the primitive had no screen calling it until phase 4. Phase 4 is
verified too: the five screens walked on a TTY as root and again unprivileged,
with Apply correctly withheld from the latter. All phases done.
